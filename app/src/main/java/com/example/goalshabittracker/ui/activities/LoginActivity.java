...
public class LoginActivity extends AppCompatActivity {
    ...
    private void configureFacebookLogin() {
        ...
        btnFacebookLogin.registerCallback(mCallbackManager, new FacebookCallback<>() {
            @Override
            ...
            public void onError(@NonNull FacebookException error) {
                hideProgressBar();
                showToast(getString(R.string.facebook_authentication_failed) + error.getMessage());
            }
        });
    }
                ...
                .addOnCompleteListener(this, task -> {
                    ...
                    if (task.isSuccessful()) {
                        ...
                        if (task.getException() != null) {
                            showToast(getString(R.string.authentication_failed) + task.getException().getMessage());
                        } else {
        ...
        mAuth.signInAnonymously()
                .addOnCompleteListener(this, task -> {
                    ...
                    if (task.isSuccessful()) {
                        ...
                        showToast(getString(R.string.anonymous_authentication_failed));
                        updateUI(null);
                    }
                });
    }
        ...
        mAuth.signInWithCredential(credential)
                .addOnCompleteListener(this, task -> {
                    ...
                    if (task.isSuccessful()) {
                        ...
                        showToast(getString(R.string.google_authentication_failed));
                        updateUI(null);
                    }
                });
    }
        ...
        mAuth.signInWithCredential(credential)
                .addOnCompleteListener(this, task -> {
                    ...
                    if (task.isSuccessful()) {
                        ...
                        showToast(getString(R.string.facebook_authentication_failed));
                        updateUI(null);
                    }
                });
    }
